/* EXERCICIO 08 Script de CREATE do DB curso_etec e suas tabelas */
...
insert into  materia (id_mat, id_prof, id_tur, nm_mat, sg_mat) 
	...
	/* 5) A-> FAZER UMA JUNÇÃO DE TODOS OS DADOS DAS TABELAS: AREA E CURSO  */
		select * 
		from area a
		...
		/* B-> FAZER UMA JUNÇÃO DOS DADOS DAS TABELAS: area,curso e professor SELECIONANDO OS DADOS CORRESPONDENTES AS TABELAS: id_area, nm_are, nm_cur e nm_prof. */
	...
	/* C-> FAÇA  O EXERCICIO B ORDENANDO POR PELO IDENTIFICADOR DA ÁREA(id_area) */
	...
	/* D->	FAZER UMA JUNÇÃO DOS DADOS DAS TABELAS: area, curso, 
	professor e matéria SELECIONANDO OS DADOS CORRESPONDENTES AS TABELAS: 
	id_are, nm_are, nm_cur, nm_prof, nm_mate e sg_mat. ORDENANDO PELO IDENTIFICADOR DO PROFESSOR (id_prof) */
	...
	/* E-> FAZER O EXERCÍCIO ANTERIOR SOMENTE PARA ÁREA
	= 1 (INFORMATICA), UTILIZANDO A CLÁUSULA WHERE */
